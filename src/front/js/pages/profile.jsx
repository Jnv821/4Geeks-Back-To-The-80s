    ...
    return (
        <>
            ...
            <div className="container">
                    ...
                    <div className="d-flex col-lg-12 col-xs-12 text-white">
                        ...
                        <div className="col-8 mx-4">
                            ...
                            <p>
                                ...
                                adipisicing elit. Totam ratione nobis eum, culpa
                                possimus odio distinctio vel, sapiente cumque
                                blanditiis eos, magni temporibus provident
                                expedita consequatur cupiditate mollitia est
                                incidunt?
                            </p>
                        </div>
                    </div>
                ...
                <div className="row">
                    <h1 className="text-white">Favorite Artists</h1>
                    <CardCharacter />
                </div>
                <div className="row">
                ...
                <div className="row">
                    <h1 className="text-white">Favorite Songs</h1>
                    <CardCharacter />
                </div>
            </div>
        </>
